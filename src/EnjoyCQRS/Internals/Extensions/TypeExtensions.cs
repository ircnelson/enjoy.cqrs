...
namespace GreenPipes.Internals.Extensions
{
    ...
    public static class TypeExtensions
    {
        ...
        {
            TypeInfo typeInfo = type.GetTypeInfo();
            return typeInfo.IsGenericType && typeInfo.GetGenericTypeDefinition().GetTypeInfo() == typeof(Nullable<>).GetTypeInfo();
        }
        ...
        public static bool IsNullable(this Type type, out Type underlyingType)
        {
            ...
            bool isNullable = typeInfo.IsGenericType
                && typeInfo.GetGenericTypeDefinition().GetTypeInfo() == typeof(Nullable<>).GetTypeInfo();
        ...
        {
            TypeInfo typeInfo = type.GetTypeInfo();
            return !typeInfo.IsValueType || type.IsNullable() || typeInfo.GetType() == typeof(string);
        }
